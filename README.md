Este projeto utiliza OpenCV e MediaPipe para reconhecer gestos das mãos e controlar aplicativos no Windows, como Bloco de Notas, Calculadora, Paint e VLC Media Player.
